...
struct NOCUBETECH_API LandscapeBumpState {
	...
	LandscapeBumpState(float averageDeltaAbs)
		: averageDeltaAbs(averageDeltaAbs)
	{
	}
};
...
struct NOCUBETECH_API AdditionalObjectGenerationData {
	...
	AdditionalObjectGenerationData(float x, float y, float groundHeight, const int64& seed)
		: x(x), y(y), groundHeight(groundHeight), seed(seed)
	{
	}
};